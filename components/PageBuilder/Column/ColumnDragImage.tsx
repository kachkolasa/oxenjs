...
const ColumnDragImage = () => {
    return (
        <>
            <div className="bg-white rounded-lg border shadow w-[120px] h-[120px] absolute pointer-events-none z-[9] flex flex-col items-center justify-center text-center">
